...
<body>
	<header>
		...
		<div data-aos="fade-right" data-aos-duration="1000">
			<h1>
				<span>Advocate Sign-In/Sign-Up</span>
			</h1>
		</div>
	</header>
	...
	<section class="container my-5">
		...
		<div class="row">
			...
			<div class="col">
				<h3>Sign-Up</h3>
				<form action="AdvocateRegister" method="post"
					...
					<div class="my-4 col">
						<div class="input-group">
							...
							<textarea cols="3" name="address" maxlength="500"
								placeholder="Address" class="form-control" required></textarea>
						</div>
					</div>
					<div class="my-4 col">
						<div class="input-group">
